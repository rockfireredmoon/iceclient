...
@Command(names = { "region", "say", "tell", "trade", "damage", "party", "clan",
	"custom", "system", "gm", "error", "emote", "friends" })
public class Channel extends AbstractCommand {
	...
	final ChatAppState chatState = console.getApp().getStateManager()
		.getState(ChatAppState.class);
