 ...
 */
public class CopyOfPlayerPhysicsControl extends AdvancedCharacterControl implements MoveableCharacterControl.Listener {

	private MoveableCharacterControl moveableControl;
	private final static Logger LOG = Logger.getLogger(CopyOfPlayerPhysicsControl.class.getName());
